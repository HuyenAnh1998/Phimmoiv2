					...
					<div class="carousel-item">
						<div class="row">
							<c:forEach items="${list3}" var="o">
								<div class="col-3">
									<a href="detail?id=${o.id }" class=""> <img
										src="${o.imageURL }" class="card-img-top" alt="${o.title}">
										<p class="show_txt text-primary">${o.title}</p></a>
		...
		<div class="container">
			...
			<div class="row">
				<c:forEach items="${phimBoCapNhat}" var="o">
					<div class="col-12 col-md-4 col-xl-2 col-lg-3 col-sm-6 container">
						<a href="detail?id=${o.id }"> <img src="${o.imageURL }"
							class="card-img-top " alt="${o.title}">
